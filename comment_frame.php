...
<body>
   ...
   <?php
      ...
      $user_query->bindValue(":post_id", $post_id, PDO::PARAM_INT);
      $user_query->execute();
      ...
      if (isset($_POST['postComment' . $post_id])) {
         ...
         $stmt = $con->prepare("INSERT INTO comments VALUES('', :post_body, :userLoggedIn, :posted_to, :date_time_now, 'no', :post_id)");
         ...
         $stmt->bindValue(":date_time_now", $date_time_now, PDO::PARAM_STR);
         $stmt->bindValue(":post_id", $post_id, PDO::PARAM_INT);
         $stmt->execute();
         // $insert_post = $stmst->fetch();
